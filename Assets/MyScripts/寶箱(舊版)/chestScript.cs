...
public class chestScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (PlayerSensor.CollisionObjects[0].GetComponent<ToturialPlayerScript>() != null) //確認是否為玩家
            {
                //下面這行為開箱判斷
                if (PlayerSensor.CollisionObjects[0].GetComponent<ToturialPlayerScript>().hasGoldKey == true && this.isOpen == false)
                {
                    this.isOpen = true;
