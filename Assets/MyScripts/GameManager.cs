...
public class GameManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (jumpHintTrigger.GetComponent<CollisionListScript>().CollisionObjects[0].GetComponent<ToturialPlayerScript>() != null) //確認是否為玩家
            {
        ...
        {
            if (NVGHintTrigger.GetComponent<CollisionListScript>().CollisionObjects[0].GetComponent<ToturialPlayerScript>() != null) //確認是否為玩家
            {
        ...
        if (Player.GetComponent<ToturialPlayerScript>().CurrentHP <= 0)
        {
            this.GameOver();
        }
    }
    ...
    {
        Player.GetComponent<ToturialPlayerScript>().PlayerRespawn();
        DeadMenu.SetActive(false);
